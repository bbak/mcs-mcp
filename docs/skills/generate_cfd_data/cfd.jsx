...
const cfd = MCP_RESPONSE.data.cfd_data;

const BOARD_ID    = CHART_ATTRS.board_id;
const PROJECT_KEY = CHART_ATTRS.project_key;
const BOARD_NAME  = CHART_ATTRS.board_name;

// Status order from workflow mapping (authoritative) — passed via CHART_ATTRS
const STATUS_ORDER_NAMES = CHART_ATTRS.status_order_names;
